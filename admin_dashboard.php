                    ...
                    <tr <?php echo ($u['status'] == 'inactive') ? 'style="background-color: #f8f9fa; opacity: 0.8;"' : ''; ?>>
                        ...
                        <td>
                            <?php if($u['status'] == 'active'): ?>
                                <span class="text-success small fw-bold"><i class="fas fa-circle me-1" style="font-size: 8px;"></i> متصل/نشط</span>
                            <?php else: ?>
                                <span class="text-danger small fw-bold"><i class="fas fa-circle me-1" style="font-size: 8px;"></i> معطل</span>
                            <?php endif; ?>
                        </td>
                  <td>
    <?php if($u['id'] != 1): ?>
